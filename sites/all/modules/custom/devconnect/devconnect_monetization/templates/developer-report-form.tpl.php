...
<div id="create-report">
  <div class="intro">
    ...
    <p>Save &amp; Close will save a copy of your chosen report in the Saved Reports section.<br>This will enable you to generate the reports again at a future date.</p>
  </div>
