...
<div class="tabbable">
  <ul class="nav nav-tabs">
    <li <?php echo $was_plan_purchased ? '' : 'class="active"'; ?>><a data-toggle="tab" href="#tab1">Catalog</a></li>
    <li <?php echo $was_plan_purchased ? 'class="active"' : ''; ?>><a data-toggle="tab" href="#tab2">Purchased Plans</a></li>
  </ul>
  <div class="tab-content">
    <div class="tab-pane<?php echo $was_plan_purchased ? '' : ' active'; ?>" id="tab1">
      <table>
        <thead>
          <tr>
            <th>Package Name</th>
    ...
    <div class="tab-pane<?php echo $was_plan_purchased ? ' active' : ''; ?>" id="tab2">
      <table>
        <thead>
          <tr>
            <th>Package</th>
