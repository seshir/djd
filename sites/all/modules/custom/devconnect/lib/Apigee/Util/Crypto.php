...
class Crypto {
  ...
  public static function encrypt($string) {
    ...
    $encrypted = mcrypt_encrypt(MCRYPT_RIJNDAEL_128, self::getCryptoKey(), $encrypt, MCRYPT_MODE_CBC, $iv);
  ...
  public static function decrypt($scrambled) {
    ...
    $decrypted = mcrypt_decrypt(MCRYPT_RIJNDAEL_128, self::getCryptoKey(), base64_decode($string_encrypted), MCRYPT_MODE_CBC, $iv);
