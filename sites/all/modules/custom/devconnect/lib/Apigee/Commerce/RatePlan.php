...
{ // class is inclosed in curly bracets due to an overlapping issue in namespaces. Need to figure out how to avoid it
  ...
  class RatePlan extends Base\BaseObject {
    ...
    /**
     * com.apigee.commerce.model.Organization
    ...
    /**
     * MonetizationPackage
     * @var \Apigee\Commerce\MonetizationPackage
     */
    ...
    /**
     * com.apigee.commerce.model.DeveloperCategory
    ...
    /**
     * com.apigee.commerce.model.ApplicationCategory
    ...
    /**
     * Rate plan details
     * @var array Array must elements must be instances of Apigee\Commerce\DataStructures\RatePlanRate
     */
    ...
    public function __construct($m_package_id, \Apigee\Util\APIClient $client) {
      ...
      $this->base_url = '/commerce/organizations/' . rawurlencode($client->getOrg()) . '/monetization-packages/' . rawurlencode($m_package_id) . '/rate-plans';
    ...
    public function getList($page_num = NULL, $page_size = 20, $current = true, $all_available = true) {
      ...
      $url = '/commerce/organizations/' . rawurlencode($this->client->getOrg()) . '/monetization-packages/' . rawurlencode($this->m_package_id) . '/developers/' . rawurlencode($this->developer->getEmail()) . '/rate-plans?current=' . $current . '&allAvailable=' . $all_available;
      $this->client->get($url);
    ...
    /**
     * Get com.apigee.commerce.model.Organization
     ...
     * @return \Apigee\Commerce\MonetizationPackage
     */
     ...
     * @return \Apigee\Commerce\RatePlan
     */
    ...
    /**
     * Get com.apigee.commerce.model.Developer
    ...
    /**
     * Get com.apigee.commerce.model.DeveloperCategory
     ...
     * @return \Apigee\Commerce\DeveloperRatePlan
     */
    ...
    /**
     * Get com.apigee.commerce.model.ApplicationCategory
     * @return \Apigee\Commerce\ApplicationCategory
     */
     ...
     * @return array Array must elements must be instances of Apigee\Commerce\DataStructures\RatePlanRate
     */
    ...
    */
    ...
    /**
     * Set com.apigee.commerce.model.Organization
     ...
     * @param \Apigee\Commerce\MonetizationPackage $monetization_package
     */
     ...
     * @param \Apigee\Commerce\DataStructures\SupportedCurrency $currency
     */
     ...
     * @param \Apigee\Commerce\RatePlan $parent_rate_plan
     */
    ...
    /**
     * Set com.apigee.commerce.model.Developer
    ...
    /**
     * Set com.apigee.commerce.model.DeveloperCategory
     * @param \Apigee\Commerce\DeveloperCategory $developer_category
     */
     ...
     * @param \Apigee\Commerce\DeveloperRatePlan $developer_rate_plan
     */
    ...
    /**
     * Set com.apigee.commerce.model.ApplicationCategory
     * @param \Apigee\Commerce\ApplicationCategory $application_category
     */
     ...
     * @param \Apigee\Commerce\Organization $exchange_organization
     */
     ...
     * @param \Apigee\Commerce\DataStructures\RatePlanRate $rate_plan_detail
     */
