...
/**
 * @file
 * Superclass of all independent API objects in the Commerce hierarchy.
 *
 * @author Daniel Johnson <djohnson@apigee.com>
 * @since 10 May 2013
 */

namespace Apigee\Commerce\Base;
...
abstract class BaseObject extends \Apigee\Util\APIObject {
   ...
   *
   * @return \Apigee\Commerce\Base\BaseObject
   */
