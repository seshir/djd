...
class PricePoint extends Base\BaseObject {
  ...
  public function __construct($product_id, \Apigee\Util\APIClient $client) {
    ...
    $this->base_url = '/commerce/organizations/' . rawurlencode($this->org) . '/products/' . rawurlencode($product_id) . '/price-points';
    $this->wrapper_tag = 'pricePoints';
    $this->id_field = 'id';
  ...
  public function initValues() {
    $this->id = '';
    $this->net_start_price = 0;
    $this->net_end_price = 0;
    $this->gross_start_price = 0;
    $this->gross_end_price = 0;
   ...
   * @return double
   */
  public function getGrossStarPrice() {
   ...
   * @return void
   */
  public function setGrossStarPrice($gross_start_price) {
   ...
   * @return void
   */
  public function setOrganization(\Apigee\Commerce\Organization $organization) {
    $this->organization = $organization;
  }
