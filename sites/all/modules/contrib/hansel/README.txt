...
6. Exporting / importing
------------------------
The Hansel export module provides two ways of exporting your configuration:
...
Both options are available under the "Export" tab. There is also an "Import" tab
available where you can import any Hansel configuration dump.
